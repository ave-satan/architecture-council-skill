...
Текущий краткий срез: около 300–600 слов. Подробные события остаются в
[журнале](process-log.md); прежние выводы сохраняются по ссылке на значимом checkpoint.
Не добавляй отдельный раздел после каждого действия.
